...
ACTIONS = [
    ...
    ("🎤", "Dettatura vocale",                "Tieni premuto F9 e parla: chiave Gemini per correggere meglio l'italiano",
     "$HOME/.config/hypr/UserScripts/ChiaveGemini.sh"),
...
FEATURES = [
    ...
    "🎤  Dettatura vocale in italiano: tieni premuto F9 e parla",
    "🔤  OCR dallo schermo con SUPER+ALT+T, anche sui video",
